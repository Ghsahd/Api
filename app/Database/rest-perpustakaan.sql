...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Mar 2024 pada 03.45
...
(10, 'BK0008', 'Politik Dinasti ', 'jokowi', 'CV jakarta ', '2006', 'politik ', 6, 'Rak 8', 'jakarta ', '2024-02-15'),
(11, 'BK0009', 'Prabowo', 'Prabowo Subianto ', 'CV Kemenhan ', '2017', 'Politik', 10, 'Rak 8', 'Hambalang', '2024-02-15'),
(12, 'BK0010', 'Prabowo Presiden ', 'Prabowo ', 'Kemenhan ', '2019', 'Politik dong', 10, 'Rak 80', 'Hambalang Tes', '2024-02-15');
...
(2, 'BK0001', 'Iwan Fals', 'iwan', 'iwan', '2003', 'musis', 15, '2023-12-15', 'https://online.fliphtml5.com/dbefk/xesx/', 'https://online.fliphtml5.com/dbefk/xesx/'),
(5, 'BKD005', 'CINTA PERANG BANJAR', 'H.Adim Arijcdl', 'Suwito ', '2020', 'sejarah ', 4, '2023-12-24', 'https://online.fliphtml5.com/gqexz/fkkm/', 'https://online.fliphtml5.com/gqexz/fkkm/'),
(6, 'BKD006', 'CINTA PERANG BANJAR', 'H.Adim Arijcdl', 'Suwito ', '2020', 'sejarah ', 4, '2023-12-24', 'https://online.fliphtml5.com/gqexz/fkkm/', 'https://online.fliphtml5.com/gqexz/fkkm/'),
(7, 'BKD011', 'Prabowo buku digital ', 'Prabowo ', 'Kemenhan ', '2013', 'politik ', 10, '2024-02-15', 'https', 'https'),
(8, 'BKD007', 'Prabowo ', 'Prabowo ', 'Kemenhan tes ', '2019', 'politik ', 11, '2024-02-15', 'https tes', 'https');
...
(3, 'RSK005', 'BK0005', 7, '2024-02-15', 2, 'kehujanan rusak jadinya ');
...
(2, 'BK0001', 'AGT001', 'Diterima', '2023-12-24', '2023-12-27'),
(3, 'BK0001', 'AGT006', 'Diterima', '2023-12-24', '2023-12-27'),
(4, 'BK0001', 'AGT006', 'Diterima', '2023-12-24', '2023-12-27'),
(5, 'BK0001', 'AGT006', 'Diajukan', '2024-01-08', '2024-01-11');
...
--
ALTER TABLE `buku_digital`
  MODIFY `id_buku_digital` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `buku_rusak`
--
ALTER TABLE `buku_rusak`
  MODIFY `id_buku_rusak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `peminjaman_online`
  MODIFY `id_peminjaman_online` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
